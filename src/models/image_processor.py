...
import utils.transformation_configs as trans_configs
...
def _augment_trans(original_images, attack_args):
    ...
    elif augment_trans == trans_configs.AUGMENT_TRANSFORMATIONS.FEATURE_AUTMENTATION.value:
        data_generator = ImageDataGenerator(featurewise_center=True, featurewise_std_normalization=True)
    elif augment_trans == trans_configs.AUGMENT_TRANSFORMATIONS.ZCA_WHITENING.value:
    ...
    elif augment_trans == trans_configs.AUGMENT_TRANSFORMATIONS.PCA_WHITENING.value:
...
def _geometric_trans(original_images, attack_args):
    ...
    if geo_trans == trans_configs.GEOMETRIC_TRANSFORMATIONS.SWIRL.value:
        ...
        for img in original_images:
            ...
            if geo_trans == trans_configs.GEOMETRIC_TRANSFORMATIONS.IRADON.value:
